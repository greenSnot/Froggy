...
import { clone, for_each_brick, } from 'froggy';
const categories = {
    control,
    data,
    event,
...
const map_child = (j, key) => Object.keys(j).reduce((m, i) => {
    m[i] = j[i][key];
    return m;
}, {});
const flatten = (i) => Object.keys(i).reduce((m, j) => {
    return Object.assign(Object.assign({}, m), i[j]);
}, {});
const init_categories = (c) => {
